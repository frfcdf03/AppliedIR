...
import retriever.ConjucntiveDocumentAtATimeRetrieval;
import retriever.DocumentAtATimeRetrieval;
...
public class SimpleIndex {
     ...
     * @throws IOException
     */
    public List<Entry> query(String q,int k) throws IOException {
        Tokenizer tokenizer = new BlankSpaceTokenizer();
        Retriever retriever = new DocumentAtATimeRetrieval();
